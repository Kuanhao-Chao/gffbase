.. _connections--connections-concurrency:
...
.. _connections--close-what-you-open:
...
.. _connections--what-happens-if-you-dont:
...
.. _connections--whose-connection-is-it:
...
.. _connections--reading-from-many-processes:
...
.. important::
   ...
   **Open the handle inside the worker**
...
.. _connections--what-read-only-refuses:
...
.. _connections--schema-upgrades-are-disabled:
...
.. _connections--one-handle-one-thread:
...
.. _connections--in-memory-databases:
