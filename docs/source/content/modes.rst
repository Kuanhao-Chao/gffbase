.. _modes--compatibility-strict-modes:
...
.. _modes--the-two-axes-underneath:
...
.. list-table::
   ...
   * - ``strict``
     - ``ncbi``
     - ``raise``
     - The full GFF3 specification. A violation **rejects** the line, with a line number.
...
.. _modes--why-compat-is-the-default:
...
.. _modes--discontinuous-features-the-case-that-actually-matters:
...
.. warning::
   ...
   **Duplicate IDs are an error by default**
...
.. _modes--conflicting-gtf-parent-identifiers:
...
.. _modes--what-the-parser-enforces:
...
.. _modes--how-the-mode-is-recorded:
